...
\begin{rexregexBox}[float=htbp,title={RexRegex code for validating email addresses},breakable,label=code:emailPattern,width=12cm,center,listing options={style=rexregex,basicstyle=\small\ttfamily}]
define ipAddress as
    begin separatedBy(".")
        1 to 3 of DIGIT
    end
