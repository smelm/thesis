...
While there are many solutions available, none address the portability issue of regular expressions which are a primary focus of this work. It also tries to improve upon the appeal to non-programmers.
