\chapter{Issues of Regular Expressions} \label{chapter:motivation}
...
\begin{newBoxTable}[title={Character Distribution in Regex},label=tab:regexCharDist,width=11cm,center]{X|r|r|r}
